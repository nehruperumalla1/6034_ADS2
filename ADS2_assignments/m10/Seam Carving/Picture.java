...
public final class Picture implements ActionListener {
    ...
    /**.
      ...
      * The result is a <code>width</code>-by-<code>height</code>
      * matrix of pixels,
      * where the color of a pixel is represented using 6 hex
      * digits to encode
    ...
    /**.
      ...
      * @throws IllegalArgumentExceptionif {@code name} is {@code null}
      */
    ...
    /**.
      ...
      *
      * @param  file the file
      * @throws IllegalArgumentException if {@code file} is
      * {@code null}
      */
