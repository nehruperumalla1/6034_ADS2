...
public final class StdOut {
    // force Unicode UTF-8 encoding; otherwise it's
    // system dependent
    /**.
    */
    ...
    */
    ...
    /**.
      * Terminates the current line by printing the
    ...
    /**.
      * Prints an object to this output stream and then
      * terminates the line.
      *
    ...
    /**.
      * Prints a boolean to standard output and then
      * terminates the line.
      *
    ...
    /**.
      * Prints a character to standard output and then 
      * terminates the line.
      *
    ...
    /**.
      * Prints a double to standard output and then
      * terminates the line.
      *
    ...
    /**.
      * Prints an integer to standard output and then
      * terminates the line.
      *
    ...
    /**.
      * Prints a long to standard output and then
      * terminates the line.
      *
    ...
    /**.
      * Prints a short integer to standard output and
    ...
    /**.
      * Prints a byte to standard output and then
      * terminates the line.
      * <p>
    ...
    /**.
      * Prints an object to standard output and
      * flushes standard output.
      *
      * @param x the object to print
      */
    ...
    /**.
      * Prints a boolean to standard output and
      * flushes standard output.
      *
      * @param x the boolean to print
      */
    ...
    /**.
      * Prints a character to standard output and
      * flushes standard output.
      *
      * @param x the character to print
      */
    ...
    /**.
      * Prints a double to standard output and
      * flushes standard output.
      *
      * @param x the double to print
      */
    ...
    /**.
      * Prints a float to standard output and
      * flushes standard output.
      *
    ...
    /**.
      * Prints an integer to standard output and
      * flushes standard output.
      *
      * @param x the integer to print
      */
    ...
    /**.
      * Prints a long integer to standard output and
      * flushes standard output.
      *
    ...
    /**.
      * Prints a byte to standard output and flushes
      * standard output.
      *
      * @param x the byte to print
      */
    ...
    /**.
      * Prints a formatted string to standard output, using
